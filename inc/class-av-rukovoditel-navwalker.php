...
if ( ! class_exists( 'AV_Rukovoditel_Navwalker' ) ) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class AV_Rukovoditel_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ( isset( $args->has_children ) && $args->has_children ) {
                $title = '<span class="title width-icon submenu submenu-level-' . $depth . '">' . $title . '</span><span class="arrow "></span>';    
            } else {
                $title = '<span class="title level-' . $depth . '">' . $title . '</span>'; 
            }
